...
scopes = /\b(JuliaFile|module|function|quote|macro|while|do|type|struct|for|if|else|elseif|try|catch|finally|[^:]end)\b/g; // omit 'g' to make match act like exec but in array form
